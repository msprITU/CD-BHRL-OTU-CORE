...
def parse_args():
    ...
    parser.add_argument('--seq_name', default=None, help='the class_name')
    parser.add_argument('--ann_file', default=None, help='the class_name')
    parser.add_argument('--work_dir', default=None, help='the class_name')
    parser.add_argument('--seq_img_id', help='the class_name')

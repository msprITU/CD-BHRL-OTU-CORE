...
#data_root = 'data/VOT/'
#data_root = "/root/BHRL/data/VOCdevkit/"
data_root = ""
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        #ann_file="/root/BHRL/vot_annotation/{}/vot_{}_test.json". format(VOT_CLASS, VOT_CLASS),
        #ann_file="/root/BHRL/vot_annotation/ft/group1_reverse_quarter_ft.json",
        #ann_file="/root/BHRL/deneme.json",
        #ann_file="/root/BHRL/vot_annotation/ft/{}_first_ft.json". format(VOT_CLASS),
        ann_file="",
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'dior_annotation/instances_test5.json',
        img_prefix="data/DIOR/test",
...
runner = dict(type='EpochBasedRunner', max_epochs=209)
checkpoint_config = dict(interval=109)
# yapf:disable
log_config = dict(
    interval=1,
    hooks=[
...
log_level = 'INFO'
#work_dir = "/root/BHRL/work_dirs/vot/BHRL/first_images_seperate/{}".format(VOT_CLASS)
work_dir = ""
load_from = 'resnet_model/res50_loadfrom.pth'
resume_from = '/root/BHRL/checkpoints/model_split3.pth'
#resume_from=None
workflow = [('train', 1)]
